...
class Payment(models.Model):
    ...
    task = models.ForeignKey('todo.TodoTask', on_delete=models.CASCADE, blank=True, null=True)
...
class Card(models.Model):
    ...
    loan_link = models.ForeignKey('passives.Loans', on_delete=models.CASCADE, blank=True, null=True)
    from_loan = models.BooleanField(blank=True, null=True, default=False)

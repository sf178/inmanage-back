...
from .models import ActivesLoans, ActivesDeposit
from actives.models import MainLoans, MainDeposits
from actives.serializers import ActivesIncomeSerializer, ActivesExpensesSerializer
from .serializers import ActivesLoansSerializer, ActivesDepositsSerializer
...
class ActivesDepositListView(mixins.ListModelMixin,
    ...
    def perform_create(self, serializer):
        ...
        main_deposit = MainDeposits.objects.create(user=deposit.user)
